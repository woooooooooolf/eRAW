...
const CATALOG = {
  ...
  "toolbar.channelDisplay": message("Channel display", "通道显示", "通道顯示", "チャンネル表示", "Visualización de canales", "Affichage des canaux", "Kanalanzeige"),
  "toolbar.allChannels": message("All channels", "全部通道", "全部通道", "全チャンネル", "Todos los canales", "Tous les canaux", "Alle Kanäle"),
  ...
  "settings.pixelInspection": message("Pixel inspection", "像素检查", "像素檢查", "画素検査", "Inspección de píxeles", "Inspection des pixels", "Pixelprüfung"),
  "settings.pixelInspectionHint": message("Control channel coloring; values are shown only when a pixel cell can contain them completely.", "控制通道着色；数值仅在像素格能够完整容纳时显示。", "控制通道著色；數值僅在像素格可完整容納時顯示。", "チャンネルの着色を設定します。値は画素セル内に完全に収まる場合のみ表示されます。", "Controle el color de los canales; los valores solo se muestran cuando caben completamente en la celda.", "Contrôlez la coloration des canaux ; les valeurs ne sont affichées que si elles tiennent entièrement dans la cellule.", "Kanalfärbung einstellen; Werte werden nur angezeigt, wenn sie vollständig in die Pixelzelle passen."),
