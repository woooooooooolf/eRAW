...
const CATALOG = {
  ...
  "statistics.tab.overview": message("Overview", "总览", "總覽", "概要", "Resumen", "Vue d’ensemble", "Übersicht"),
  "statistics.tab.histogram": message("Histogram", "Histogram", "Histogram", "Histogram", "Histogram", "Histogram", "Histogram"),
  "statistics.tab.profiles": message("Profiles", "Profiles", "Profiles", "Profiles", "Profiles", "Profiles", "Profiles"),
  "statistics.tab.report": message("Report", "报告", "報告", "レポート", "Informe", "Rapport", "Bericht"),
  ...
  "statistics.histogram": message("DN Histogram", "DN Histogram", "DN Histogram", "DN Histogram", "Histogram DN", "Histogram DN", "DN-Histogram"),
  "statistics.histogramCumulative": message("Cumulative DN Histogram", "累计 DN Histogram", "累計 DN Histogram", "累積 DN Histogram", "Histogram DN acumulado", "Histogram DN cumulé", "Kumulatives DN-Histogram"),
  ...
  "statistics.mean": message("Mean", "Mean", "Mean", "Mean", "Mean", "Mean", "Mean"),
  "statistics.standardDeviation": message("Standard Deviation", "Standard Deviation", "Standard Deviation", "Standard Deviation", "Standard Deviation", "Standard Deviation", "Standard Deviation"),
  "statistics.meanDn": message("Mean DN", "Mean DN", "Mean DN", "Mean DN", "Mean DN", "Mean DN", "Mean DN"),
  "statistics.stdDevDn": message("Standard Deviation DN", "Standard Deviation DN", "Standard Deviation DN", "Standard Deviation DN", "Standard Deviation DN", "Standard Deviation DN", "Standard Deviation DN"),
  ...
  "statistics.rowProfile": message("Row Profile", "Row Profile", "Row Profile", "Row Profile", "Row Profile", "Row Profile", "Row Profile"),
  "statistics.columnProfile": message("Column Profile", "Column Profile", "Column Profile", "Column Profile", "Column Profile", "Column Profile", "Column Profile"),
  "statistics.copyChart": message("Copy chart", "复制图表", "複製圖表", "グラフをコピー", "Copiar gráfico", "Copier le graphique", "Diagramm kopieren"),
  "statistics.saveChart": message("Save chart…", "图表另存为…", "圖表另存為…", "グラフを保存…", "Guardar gráfico…", "Enregistrer le graphique…", "Diagramm speichern…"),
  "statistics.copyReport": message("Copy report", "复制组合报告", "複製組合報告", "レポートをコピー", "Copiar informe", "Copier le rapport", "Bericht kopieren"),
  "statistics.saveReport": message("Save report…", "组合报告另存为…", "組合報告另存為…", "レポートを保存…", "Guardar informe…", "Enregistrer le rapport…", "Bericht speichern…"),
  "statistics.chartCopied": message("Chart copied", "图表已复制", "圖表已複製", "グラフをコピーしました", "Gráfico copiado", "Graphique copié", "Diagramm kopiert"),
  "statistics.chartSaved": message("Chart saved", "图表已保存", "圖表已儲存", "グラフを保存しました", "Gráfico guardado", "Graphique enregistré", "Diagramm gespeichert"),
  "statistics.reportCopied": message("Report copied", "组合报告已复制", "組合報告已複製", "レポートをコピーしました", "Informe copiado", "Rapport copié", "Bericht kopiert"),
  "statistics.reportSaved": message("Report saved", "组合报告已保存", "組合報告已儲存", "レポートを保存しました", "Informe guardado", "Rapport enregistré", "Bericht gespeichert"),
