...
const CATALOG = {
  ...
  "statistics.chartInteraction": message("Hover to inspect values; drag or use the range slider to zoom.", "悬停查看数值；拖动图表或范围滑块进行缩放。", "懸停檢視數值；拖曳圖表或範圍滑桿進行縮放。", "ホバーで値を確認し、ドラッグまたは範囲スライダーで拡大できます。", "Pase el cursor para ver valores; arrastre o use el control de rango para ampliar.", "Survolez pour inspecter les valeurs ; faites glisser ou utilisez le curseur de plage pour zoomer.", "Werte beim Überfahren prüfen; zum Zoomen ziehen oder den Bereichsregler verwenden."),
