...
const CATALOG = {
  ...
  "settings.pixelInspectionHint": message("Values are shown only when a pixel cell can contain them completely.", "仅在像素格能够完整容纳数值时显示，不会截断或缩写。", "僅在像素格可完整容納數值時顯示，不會截斷或縮寫。", "画素セル内に値を完全表示できる場合のみ表示します。", "Los valores solo se muestran cuando caben completamente en la celda.", "Les valeurs ne sont affichées que si elles tiennent entièrement dans la cellule.", "Werte werden nur angezeigt, wenn sie vollständig in die Pixelzelle passen."),
