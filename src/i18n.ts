...
const CATALOG = {
  ...
  "statistics.chartInteraction": message("Hover to inspect; use the horizontal and vertical range controls to zoom.", "悬停查看数值；使用横纵范围控件缩放。", "懸停檢視數值；使用橫向與縱向範圍控制縮放。", "ホバーで値を確認し、水平・垂直レンジで拡大できます。", "Pase el cursor para inspeccionar; use los controles horizontal y vertical para ampliar.", "Survolez pour inspecter ; utilisez les contrôles horizontal et vertical pour zoomer.", "Werte beim Überfahren prüfen; mit horizontalen und vertikalen Reglern zoomen."),
