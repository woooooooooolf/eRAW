...
const EN_COPY: LocaleCopy = {
  ...
  sections: {
    ...
    glossary: {
      ...
      note: { kind: "supplement", title: "Manual version", text: "This technical reference follows eRAW V0.5.5. Packing, processing, or statistical changes should update code, equations, tests, and all language catalogs as one versioned change." },
    },
  },
};
...
const ZH_TW_COPY: LocaleCopy = {
  ...
  sections: {
    ...
    glossary: {
      ...
      ], note: { kind: "supplement", title: "手冊版本", text: "本技術參考與 eRAW V0.5.5 同步。Packing、處理或統計變更應把程式、公式、測試與所有語言目錄作為同一版本變更維護。" },
    },
  },
};
...
const JA_COPY: LocaleCopy = {
  ...
  sections: {
    ...
    glossary: { kicker: "用語と主張", title: "用語集と結果の解釈", summary: "RAW workflow の用語を統一し、eRAW の結果が何を意味するかを明確にします。", level: "入門", readingTime: "約 7 分",
      ...
      ], note: { kind: "supplement", title: "マニュアル版", text: "本リファレンスは eRAW V0.5.5 に対応します。Packing、処理、統計の変更時は code、式、test、全言語 catalog を同時更新します。" } },
  },
};
...
const ES_COPY: LocaleCopy = {
  ...
  sections: {
    ...
    glossary: { kicker: "TÉRMINOS Y CONCLUSIONES", title: "Glosario e interpretación", summary: "Unifique términos RAW y determine qué conclusiones admite eRAW.", level: "Introducción", readingTime: "Unos 7 min",
      ...
      note: { kind: "supplement", title: "Versión del manual", text: "Esta referencia corresponde a eRAW V0.5.5. Cambios de Packing, procesamiento o estadísticas deben actualizar código, fórmulas, tests y todos los idiomas juntos." } },
  },
};
